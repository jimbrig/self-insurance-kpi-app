...
The data is further segmented into arbitrary segments using the following possible fields:

- Coverage (Workers Compensation or Automobile Liability)
- Business Unit
- Region
- Injury
- Vehicle
...
+ Payroll was not made available for Jake’s Finer Foods. As a result, when 
calculating Auto Liability frequency and loss rates using payroll as an exposure 
base, the application includes Jake’s AL claims and losses, respectively, but 
not an accompanying exposure base, skewing the metrics. 
